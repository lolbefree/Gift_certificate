...
class BarcodeCreating(QtWidgets.QMainWindow, cert_gui.Ui_Certificates):
    ...
    def create_barcode(self):
        ...
        if self.check_in_base(self.random_int) == 'true':
            self.create_barcode()

        cd = code128.image('C:\\AM\\BAT\\Gift_certificate\\barcods_rent_car\\{}'.format(self.random_int))
        cd.save("C:\\AM\\BAT\\Gift_certificate\\barcods_rent_car\\{}.png".format(self.random_int))
        self.fullname = "{}.png".format(self.random_int)
        # print(self.random_int, self.fullname)
        self.image_paste()

    def image_paste(self):
        img1 = Image.open('C:\\AM\\BAT\\Gift_certificate\\barcods_rent_car\\cert.jpg', )  # main image
        barcd = Image.open("C:\\AM\\BAT\\Gift_certificate\\barcods_rent_car\\{}".format(self.fullname))

        img1.paste(barcd, (0, 850))  # paste barcode to main image
        img1.save("C:\\AM\\BAT\\Gift_certificate\\barcods_rent_car\\img_with_barcode.png")  # save with barcode
